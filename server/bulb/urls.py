...
urlpatterns = [
    ...
    path("bulbs/<int:bulb_id>/access/", views.manage_access_page, name="manage_bulb_access"),
    ...
    path("reports/power/", views.power_report_page, name="power_report"),
    path("reports/activity/", views.activity_report_page, name="activity_report"),
    ...
    path("api/access-list/", views.bulb_access_list_api, name="bulb_access_list"),
    path("api/access-upsert/", views.bulb_access_upsert_api, name="bulb_access_upsert"),
    path("api/access-revoke/", views.bulb_access_revoke_api, name="bulb_access_revoke"),
